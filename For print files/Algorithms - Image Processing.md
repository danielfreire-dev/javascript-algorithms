...
![Content-aware image resizing](./images/01-resizing-options.png)
...
![JS IMAGE CARVER DEMO](./images/10-demo-01.gif)
...
![JS IMAGE CARVER OBJECT REMOVAL DEMO](./images/10-demo-02.gif)
...
![Resizing demo with more complex backgrounds](./images/11-demo-01.png)

The same goes for the ocean waves. The algorithm preserved the wave structure without distorting the surfers.

![Resizing demo with more complex backgrounds](./images/11-demo-02.png)
...
![Example when the algorithm does not work as expected](./images/12-demo-01.png)
...
![Pixels color difference](./images/30-pixel-energy-comparison.png)
...
![Pixel energy formula](./images/20-energy-formula.png)
...
![Example of pixel energy calculation](./images/30-pixel-energy-calculation-example.png)
...
![Searching the seam](./images/41-seam-search.png)
...
![Energy map example with seam](./images/40-energy-map-with-seam.png)
...
![The naive approach](./images/50-naive-approach.png)
...
![The greedy approach](./images/51-greedy-approach.png)
...
![Repeated problems](./images/52-dp-repeated-problems.png)
...
![What seam to choose](./images/53-dp-what-to-choose.png)
...
![Seams energies example](./images/56-dp-seams-energies-example.png)

In general, we have three possible previous seems to choose from:

![Three options to choose from](./images/55-dp-three-options.png)
...
![Seams energies map traversal](./images/57-dp-seams-energies-traversal.png)
...
![Deleting the seam](./images/60-deleting-example.png)
